...
public class GUIUPController : MonoBehaviour {
	...
	{ 0, 10, 15, 10, 1000, 1000 },//передвиж
	{ 1, 4, 20, 20, 1352, 2000 },//передвиж по дорогам
	{ 3, 7, 56, 20, 1346, 5000 },//улучшенное охлаждение
	{ 4, 4, 1, 60, 366, 5000 },//Ремонт
	{ 6, 8, 230, 660, 1000, 5000 },//Защита
	{ 7, 19, 11, 508, 1000, 1000 },//Защита от слизи
	{ 9, 23, 30, 303, 1000, 2000 },//Копание
	{ 13, 12, 33,606, 1000, 5000 },//Кристаллография
	{ 18, 3, 2, 222, 1000, 5000 },//Добыча
	{ 19, 2, 2, 54, 1000, 5000 },//Извлечение
	{ 20, 1, 1, 1000, 1000, 1000 },//Смежное извлечение
	{ 23, 2, 1, 1000, 1000, 5000 },//Сортировка
	{ 24, 1, 1, 567, 1000, 5000 },//Дополнительные зеленые
	{ 28, 3, 1, 1000, 2000, 2000 },//Дополнительные фиолетовые
	{ 33, 5, 1000, 3, 1000, 5000 },//Нано-упаковка
	{ 34, 1, 10, 5, 1000, 5000 },//Вместимость зелёных
	{ 38, 3, 10, 6, 1000, 2000 },//Вместимость фиолетовых
	{ 40, 3, 50, 305, 1000, 5000 },//Стройка опор
	{ 43, 3, 50, 33, 1000, 2000 },//Стройка зелёных блоков
	{ 46, 1, 30, 1000, 1000, 5000 }//Стройка дороги
	};
